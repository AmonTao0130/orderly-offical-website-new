  ...
  return (
    <div className={className || "relative size-[96px]"} data-name="CamelotLogo">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 96">
        <path d="M96 48C96 21.4903 74.5097 0 48 0C21.4903 0 0 21.4903 0 48C0 74.5097 21.4903 96 48 96C74.5097 96 96 74.5097 96 48Z" fill="var(--fill-0, #10151D)" id="base" />
      </svg>
